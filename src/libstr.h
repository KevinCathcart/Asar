...
inline string ftostrvar(long double value, int precision)
{
	...
	static const char * formats[] =
	{
		...
		"%.10Lf", "%.11Lf", "%.12Lf", "%.13Lf", "%.14Lf", "%.15Lf", "%.16Lf", "%.17Lf", "%.18Lf", "%.19Lf",
		"%.20Lf", "%.21Lf", "%.22Lf", "%.23Lf", "%.24Lf", "%.25Lf", "%.26Lf", "%.27Lf", "%.28Lf", "%.29Lf",
		"%.30Lf", "%.31Lf", "%.32Lf", "%.33Lf", "%.34Lf", "%.35Lf", "%.36Lf", "%.37Lf", "%.38Lf", "%.39Lf",
		"%.40Lf", "%.41Lf", "%.42Lf", "%.43Lf", "%.44Lf", "%.45Lf", "%.46Lf", "%.47Lf", "%.48Lf", "%.49Lf",
		"%.50Lf", "%.51Lf", "%.52Lf", "%.53Lf", "%.54Lf", "%.55Lf", "%.56Lf", "%.57Lf", "%.58Lf", "%.59Lf",
		"%.60Lf", "%.61Lf", "%.62Lf", "%.63Lf", "%.64Lf", "%.65Lf", "%.66Lf", "%.67Lf", "%.68Lf", "%.69Lf",
		"%.70Lf", "%.71Lf", "%.72Lf", "%.73Lf", "%.74Lf", "%.75Lf", "%.76Lf", "%.77Lf", "%.78Lf", "%.79Lf",
		"%.80Lf", "%.81Lf", "%.82Lf", "%.83Lf", "%.84Lf", "%.85Lf", "%.86Lf", "%.87Lf", "%.88Lf", "%.89Lf",
		"%.90Lf", "%.91Lf", "%.92Lf", "%.93Lf", "%.94Lf", "%.95Lf", "%.96Lf", "%.97Lf", "%.98Lf", "%.99Lf",
		"%.100Lf"
	};
